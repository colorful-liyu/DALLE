...
# mynotes: what does 'return val if isinstance(val, tuple) else (val,) * depth' mean?
...
class Transformer(nn.Module):
    def __init__(
        ...
        *,
        ...
        # mynotes: attn_types is mapped to tuple
        attn_type_layer = islice(cycle(attn_types), depth)
        # mynotes: cycle() means repeating it without end, and islice() decides to stop it at depth position.

...
parser.add_argument('--image_text_folder', type=str, default = '../CUB_200_2011/CUB_200_2011/images',
...
parser.add_argument('--taming', dest='taming', default = True, action='store_true')
...
parser.add_argument('--wandb_entity', default='code_liyu',
...
train_group.add_argument('--learning_rate', default = 4.5e-4, type = float, help = 'Learning rate')

train_group.add_argument('--clip_grad_norm', default = 0, type = float, help = 'Clip gradient norm')

train_group.add_argument('--lr_decay', dest = 'lr_decay', default = True, action = 'store_true')

model_group = parser.add_argument_group('Model settings')

model_group.add_argument('--dim', default = 256, type = int, help = 'Model dimension')

model_group.add_argument('--text_seq_len', default = 80, type = int, help = 'Text sequence length')

model_group.add_argument('--depth', default = 8, type = int, help = 'Model depth')
...
model_group.add_argument('--reversible', dest = 'reversible', default = False, action='store_true')
...
# helpers
# the bias and norm in transformer has no decay
...
for epoch in range(resume_epoch, EPOCHS):
    ...
    for i, (text, images) in enumerate((dl if ENABLE_WEBDATASET else distr_dl)):
        ...
        # mynote: text shape is [b, text_seq_len] and img shape is [b, 3, in_size, in_size]
